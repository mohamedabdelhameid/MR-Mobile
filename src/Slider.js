...
export function SelectCategory({ selectedCategory }) {
  ...
  return (
    <>
      ...
      {selectedCategory && (
        <div className='mt-4 text-center container' style={{direction:'rtl'}} id='productFilter'>
  ...
  return (
    <Carousel interval={3000} className='mt-3 slider'>
      <Carousel.Item onClick={() => {
        ...
        <img src={banner1} className="imgSlider d-block w-100" alt="First slide" loading="lazy" />
      </Carousel.Item>
      <Carousel.Item onClick={() => {
            navigate('/#productFilter');
            setTimeout(() => {
        ...
        <img src={banner3} className="imgSlider d-block w-100" alt="Second slide" loading="lazy" />
      </Carousel.Item>
      <Carousel.Item onClick={() => {
            navigate('/#productFilter');
            setTimeout(() => {
        ...
        <img src={banner2} className="imgSlider d-block w-100" alt="Third slide" loading="lazy" />
      </Carousel.Item>
    </Carousel>
  );
}
