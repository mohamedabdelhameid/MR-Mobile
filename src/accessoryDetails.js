...
function AccessoryDetails() {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      if (token) {
        ...
        if (!response.ok) {
          throw new Error(responseData.message || 'فشل في إضافة المنتج إلى السلة');
        }
      }
  ...
  return (
    <>
      <MyNavbar />
      <Box sx={{ direction: 'rtl' ,minHeight:'80vh',display:'flex',justifyContent:'center',alignContent:'center',marginTop:'85px'}}>
        <Box sx={{
          m: 3,
          position: "relative",
          marginTop: '85px',
                ...
                {allImages.length > 1 && (
                  <Box sx={{
                    ...
                    {allImages.map((img, index) => (
                      <Box
                        key={index}
                        onClick={() => setMainImage(`http://localhost:8000${img}`)}
                        sx={{
                          width: 80,
                          height: 80,
                          borderRadius: 1,
                          overflow: "hidden",
                          cursor: "pointer",
                          border: mainImage === `http://localhost:8000${img}` ? "2px solid #1976d2" : "1px solid #ddd",
                        }}
                      >
                        <img
                ...
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    {mergedData.brand?.name && (
                      <Grid item xs={6}>
                        <Typography variant="subtitle1">
                          <strong>الشركة:</strong> {mergedData.brand.name}
                        </Typography>
                      </Grid>
                    )}
                    {mergedData.storage && (
                      <Grid item xs={6}>
                        <Typography variant="subtitle1">
                          <strong>المساحة:</strong> {mergedData.storage} جيجا بايت
                        </Typography>
                      </Grid>
                    )}
                    {mergedData.display && (
                    ...
                    {mergedData.camera && (
                      <Grid item xs={6}>
                        <Typography variant="subtitle1">
                          <strong>الكاميرا:</strong> {mergedData.camera} ميجا بايت
                        </Typography>
                      </Grid>
                    )}
                    ...
                    {mergedData.operating_system && (
                      <Grid item xs={6}>
                        <Typography variant="subtitle1">
                          <strong>نظام التشغيل:</strong> {mergedData.operating_system}
                        </Typography>
                      </Grid>
                    )}
                    ...
                    {mergedData.battery && (
                      <Grid item xs={6}>
                        <Typography variant="subtitle1">
                          <strong>البطارية:</strong> {mergedData.battery} مللي أمبير
                        </Typography>
                      </Grid>
                    )}
                    {mergedData.color && (
                      <Grid item xs={6}>
                        <Typography variant="subtitle1">
                          <strong>اللون المتاح:</strong> {mergedData.color}
                        </Typography>
                      </Grid>
                    )}
                  </Grid>
...
//     <>
//       <MyNavbar />
//       <Box sx={{ direction: 'rtl' ,minHeight:'80vh',display:'flex',alignItems:'center',marginTop:'85px'}}>
//         <Box sx={{
//           m: 3,
//           position: "relative",
//           marginTop: '85px',
