...
function ProductDetails() {
      ...
      try {
        ...
        if (json.data) {
          ...
          if (json.data.image_cover) {
            ...
            setImageCover(`${BASE_BACKEND_LOCAHOST_URL}${json.data.image_cover}`);
          }
  ...
  useEffect(() => {
    if (selectedColor?.images?.[0]?.image) {
      ...
      setMainImage(`${BASE_BACKEND_LOCAHOST_URL}${selectedColor.images[0].image}`);
    } else if (imageCover) {
                      ...
                      <Box
                        ...
                        sx={{
                          ...
                          border:
                            ...
                            (img.image ? `${BASE_BACKEND_LOCAHOST_URL}${img.image}` : img) === mainImage
                              ? "2px solid #1976d2"
                              : "1px solid #ddd",
                        }}
                      >
                        <img
                          ...
                          src={img.image ? `${BASE_BACKEND_LOCAHOST_URL}${img.image}` : img}
                          alt={`صورة ${index + 1}`}
                          style={{
                            width: "100%",
                            height: "100%",
