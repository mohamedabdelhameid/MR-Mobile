...
//                         onClick={() => handleColorSelect(product.id, color, isAccessory)}
//                         title={color.color.name} // اسم اللون العربي أو الإنجليزي
//                         style={{
//                           backgroundColor: color.color.hex_code, // اللون الفعلي بالرمز
//                           width: "30px",
//                           height: "30px",
//                           borderRadius: "50%",
//                           cursor: "pointer",
...
//               key={brandId}
//               className={`brand-circle ${
//                 // هنا التغيير الوحيد: مقارنة الرقم بالنص أو تحويل النص لرقم
//                 selectedCategory == brandId ? "selected" : ""
//               }`}
//               // وهذا هو التغيير الوحيد اللازم لتصحيح المشكلة:
//               onClick={() => setSelectedCategory(Number(brandId))}
//             >
//               {brands[brandId].image ? (
//                 <img
//                   src={brands[brandId].image}
